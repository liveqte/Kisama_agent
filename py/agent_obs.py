...
def O0_fn_34():
    Config.validate()
    O0_fn_1()
    O0_var_397 = asyncio.new_event_loop()
    asyncio.set_event_loop(O0_var_397)
    import os
    O0_var_398 = os.path.splitext(os.path.basename(__file__))[0]
    O0_var_399 = str(O0_var_398) + codecs.decode('\\u003a\\u0061\\u0070\\u0070', 'unicode_escape')
    Logger.debug(codecs.decode('\\u0020\\u4f7f\\u7528\\u91cd\\u8f7d\\u6a21\\u5f0f\\u542f\\u52a8\\u003a\\u0020', 'unicode_escape') + str(O0_var_399))
    uvicorn.run(O0_var_399, host=Config.HOST, port=Config.PORT, reload=Config.DEBUG, log_level=codecs.decode('\\u0064\\u0065\\u0062\\u0075\\u0067', 'unicode_escape') if Config.DEBUG else codecs.decode('\\u0069\\u006e\\u0066\\u006f', 'unicode_escape'))
